...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Actualizar proceso penal</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item active">Actualizar proceso penal</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <input type="hidden" name="proc_penal_id_up" value="<?php echo $pagina[1];?>">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control apellidos" placeholder="" name="delitos_up" id="delitos_up" value="<?php echo $campos['delitos']; ?>">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <!-- text input -->
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control apellidos" placeholder="" name="victimas_up" id="victimas_up" value="<?php echo $campos['victimas']; ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Fiscalia <span class="text-danger">*</span></label>
                                    <select class="form-control" name="fiscalia_up" id="fiscalia_up">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control lista_j" name="juzg_tribu_up" id="juzg_tribu_up"  style="width:100%;" required>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control nombres" placeholder=" " name="exp_j_up" id="exp_j_up" value="<?php echo $campos['exp_judicial']; ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Estado laboral<span class="text-danger">*</span></label>
                                    <select class="form-control" name="est_lab_up" id="est_lab_up">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" style="text-transform:uppercase" name="descrip_est_up" id="descrip_est_up" cols="30" rows="5"><?php echo $campos['descrip_est_lab']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" autocomplete="off" class="form-control nombres" placeholder=" " name="fec_hechos_up" id="fec_hechos_up" value="<?php echo $campos['fec_hechos']; ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Fecha ultima actualización<span class="text-danger">*</span></label>
                                    <input type="date" autocomplete="off" class="form-control nombres" placeholder=" " name="fec_ult_act_up" id="fec_ult_act_up" value="<?php echo $campos['fec_ultima_act']; ?>">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" style="text-transform:uppercase" name="descrip_ult_act_up" id="descrip_ult_act_up" cols="30" rows="5"><?php echo $campos['descrip_ultima_act']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" style="text-transform:uppercase" name="est_proc_up" id="est_proc_up" cols="30" rows="5"><?php echo $campos['est_proceso']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control" placeholder="000-0000" name="oficio_up" id="oficio_up" value="<?php echo $campos['oficio_solicitud']; ?>">
                                </div>
                            </div>
                            <div class="col-sm-12">
