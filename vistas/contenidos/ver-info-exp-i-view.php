...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Ver información expediente de investigación</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item active">Ver información expediente de investigación</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form class="FormulariosAjax" action="<?php echo SERVERURL; ?>ajax/expedienteAjax.php" method="POST" data-form="update" autocomplete="off">
                          ...
                          <h5 class="font-weight-bold " >Datos del denunciante</h5>
                            ...
                            <hr>
                                ...
                                <div class="col-sm-6">
                                <div class="form-group">
                                    <label for=""> Nombre completo del investigado / investigados <span class="text-danger">*</span></label>
...
<script>
    $(function() {
        ...
        html = '<tr><td><input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control" placeholder="" name="investigado[]"></td><td><button type="button" class="btn btn-danger" id="remove"> Eliminar</button></td></tr>';
    });
</script>