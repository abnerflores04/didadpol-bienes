...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Ver información proceso disciplinario</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item active">Ver información proceso disciplinario</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control" placeholder="0000-0000-00000" name="identidad_up" id="identidad_up" value="<?php echo $campos['identidad_investigado']; ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control" placeholder=" " name="direccion_pol_up" id="direccion_pol_up" value="<?php echo $campos['direccion_pol']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Antiguedad en la institución policial<span class="text-danger">*</span></label>
                                        <input type="number" autocomplete="off" class="form-control" placeholder="Ingrese cantidad de años" name="antiguedad_up" id="antiguedad_up" value="<?php echo $campos['antiguedad_ins']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>RES. SEDS.<span class="text-danger">*</span></label>
                                        <input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control" placeholder="000-0000" name="n_res_seds_up" id="n_res_seds_up" value="<?php echo $campos['n_res_seds']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Fecha RES. SEDS.<span class="text-danger">*</span></label>
                                        <input type="date" autocomplete="off" class="form-control" placeholder="" name="fec_res_seds_up" id="fec_res_seds_up" value="<?php echo $campos['fec_res_seds']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>N° RES. SEDS.<span class="text-danger">*</span></label>
                                        <input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control" placeholder="000-0000" name="cod_res_seds_up" id="cod_res_seds_up" value="<?php echo $campos['cod_res_seds']; ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control apellidos" placeholder="" name="vicio_nul_up" id="vicio_nul_up" value="<?php echo $campos['vicio_nul']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Representante legal</label>
                                        <input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control apellidos" placeholder="" name="repre_legal_up" id="repre_legal_up" value="<?php echo $campos['repre_legal']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>N° Acuerdo de cancelacion<span class="text-danger">*</span></label>
                                        <input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control" placeholder="0000-0000" name="n_acuerdo_up" id="n_acuerdo_up" value="<?php echo $campos['n_acuerdo']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" style="text-transform:uppercase" class="form-control" placeholder="0000-0000" name="n_cont_admin_up" id="n_cont_admin_up" value="<?php echo $campos['n_cont_admin']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-12">
